...
<form class="form-inline" action = "factura_buscar.php?precioActual=<?php echo $_GET['precioActual']?>" method="GET">
    <input class="form-control mr-sm-2" type="hidden" placeholder="Buscar producto" aria-label="Search" name="precioActual" value="<?php echo $_GET['precioActual']?>" >
...
<a href="client_View.php?valor=<?php echo $_GET['precioActual']?>" type="button" class="btn btn btn-warning">ASIGNAR FACTURA A</a>      
</nav>
  ...
  <div>
        ...
        <?php  
          ...
          <tr>
            ...
            <td><a href="sumar.php?id=<?php echo $consulta['ID'] ?>&precios=<?php echo $consulta['Precio']?>&precioActual=<?php echo $_GET['precioActual']?>" type="button" class="btn btn btn-warning">Agregar producto</a></td>
            <?php } ?>
          </tr>
        </tbody>
      </table>
