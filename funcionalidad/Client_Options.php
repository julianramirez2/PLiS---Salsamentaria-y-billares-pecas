...
<html lan = es>
    ...
    <body>
        ...
        <div align = "center">
            <button class = "Button_Options" name = "Option_2" onclick = "location = 'Client_View.php?valor=0'"> Ver Clientes </button>
        </div>

        <!-- Crea un Botón que lleva de regreso al Menú -->
        <div align = "center">
            <button class = "Button_Back" name = "Option_3" onclick = "location = '../views/mainpage.php'"> Volver al Menú </button>
        </div>
